...
public class Unit {
    ...
    //Constructors
    //No unit shall be created senseless, so far.
    ...
    /**
     * Return true if a unit can attack another, based on the unit class
     * restrictions, imposed by game's logic. E.g., a T Copter can attach Cptr
     * clas, Inftry class, etc. This methods should also consider if the
     * attacker will likely use primary or secondary weapons.
     *
     * @param atacker
     ...
     * @return
     */
    public static boolean canAttackUnitClass(Unit atacker, Unit defender) {
        //Switch
        return false;
    }
